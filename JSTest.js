...
mintNFT("adii", "uspa", "green", "Gold Chain");
mintNFT("shreya", "zara", "brown", "Gold Chain");
mintNFT("ronni", "bearhouse", "blue", "Gold Chain");
mintNFT("priyanshu", "louisphilipe", "black", "Gold Chain");
listNFTs();
getTotalSupply();
